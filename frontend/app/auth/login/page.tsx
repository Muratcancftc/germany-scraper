      ...
      <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-8 w-full max-w-md">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div>
            ...
            <input type="email" className="w-full px-4 py-2.5 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 outline-none" value={email} onChange={(e) => setEmail(e.target.value)} required />
          </div>
          <div>
          ...
          <p className="text-center text-sm text-gray-500">
            Kein Konto? <Link href="/auth/register" className="text-blue-600 hover:underline">Registrieren</Link>
          </p>
        </form>
      </div>
    </div>
